              ...
              <div className="inner">
                ...
                <div className="block-header inner-sm">
                  ...
                  <div className="block-content">
                    <iframe width="100%" height="500" src="https://www.youtube.com/embed/OZyrYpqj2i0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                  </div>
                </div>
                )}
                  {/* <div className="block-content">
                      <iframe width="560" height="315" src='https://www.youtube.com/watch?v=qYu3pLSKTes' frameborder="0" allowfullscreen></iframe>
                  </div> */}
